...
Configures file-based logging to track application events, errors,
and user actions for administrative review and troubleshooting.
"""
...
if not logger.handlers:
    ...
    # Console handler for development environment visibility
